...
public class CommonMethods extends BaseClass {
	...
	/**
	 * This method checks if radio/checkbox is enable and then click on the element
	...
	/**
	 * This method put the thread to sleep and handles the exception for us.
	 * 
	 * @param seconds
	 */
	...
	/**
	 * This method will check if an index exists in the dropdows and only then
	 * select it.
	 * 
	 * @param element
	 * @param index
	 ...
	 * exception will be caught and a null will be returnd.
	 * 
	 * @return
	 */
	...
	/**
	 * This method will switch to a frame using id. It will also handle the
	 * 
	 * @param i
	 */
	...
	/**
	 * This method will switch to a frame using name. It will also handle the
	 * 
	 * @param string
	 */
	...
	/**
	 * This method will switch to a frame using WebElement. It will also handle the
	 * 
	 * @param string
	 */
	...
	/**
	 * This method will scroll the page down based on the past pixel parameter
	 * 
	 * @param pixel
	 */
	...
	/**
	 * This method will scroll the page up based on the past pixel parameter
	 * 
	 * @param pixel
	 */
